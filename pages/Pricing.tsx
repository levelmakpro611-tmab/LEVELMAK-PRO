...
import { Check, X, Shield, Landmark, Star, Sparkles, Award, Zap } from 'lucide-react';
                ...
                {receiptData && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-md">
                        ...
                        >
                            ...
                            {/* Receipt Body */}
                            <div className="py-6 space-y-4 text-xs font-bold">
                                ...
                                <div className="space-y-2 bg-blue-50/50 p-4 rounded-2xl border border-blue-100 text-blue-900 leading-relaxed">
                                    <p className="text-[9px] font-black uppercase tracking-widest text-blue-700">Durée de Validité</p>
                                    <p className="text-[13px] font-black">
                                        Valable jusqu'au : <span className="underline">{receiptData.expiresAt}</span>
                                    </p>
                                    <p className="text-[10px] font-medium opacity-85 mt-1">
                                        À cette échéance, votre accès repassera automatiquement au mode gratuit. Vous pourrez alors renouveler votre abonnement à tout moment.
                                    </p>
                                </div>
                            </div>
