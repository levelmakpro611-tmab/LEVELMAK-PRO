      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-gradient-to-b from-[#0e1626] to-[#080d18] border-2 border-amber-500/30 rounded-[2.5rem] p-8 shadow-[0_20px_50px_rgba(245,158,11,0.15)] text-center overflow-hidden"
          >
            ...
            {/* Message */}
            <div className="text-slate-350 text-sm leading-relaxed font-medium mb-8 whitespace-pre-line px-2">
              {displayMessage}
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-amber-500 via-amber-600 to-yellow-600 hover:from-amber-400 hover:to-yellow-500 text-slate-950 rounded-2xl font-black uppercase tracking-widest text-[11px] transition-all active:scale-[0.98] shadow-lg shadow-amber-500/10 flex items-center justify-center gap-2"
              >
                {isMobile ? (
              ...
              <button
                onClick={onClose}
                className="w-full py-3 bg-transparent hover:bg-white/5 text-slate-400 hover:text-white rounded-2xl font-bold text-xs transition-colors"
              >
